...
public class CameraActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    // Will check if permission was granted
    private boolean checkPermission(){
        return (ContextCompat.checkSelfPermission(CameraActivity.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED);
    }
